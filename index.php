				...
				<div class="col-md-4">
					<div class="our_qualities_column">
	                    ...
	                    <div class="caption">
	                        ...
	                        <p>
							Retains its natural juices, contributing to a flavorful and enjoyable eating experience. It describes meat that is succulent, moist, and tender, often resulting from slow cooking methods such as smoking or grilling low and slow. 
	                        </p>
	                    </div>
	                </div>
				</div>
				<div class="col-md-4">
					<div class="our_qualities_column">
	                    ...
	                    <div class="caption">
	                        ...
	                        <p>
							Rich in taste and aroma. Flavorfulness can come from various sources such as seasoning blends, marinades, smoke, and cooking techniques. It refers to the depth and complexity of taste sensations experienced when 
	                        </p>
	                    </div>
	                </div>
				</div>
				<div class="col-md-4">
					<div class="our_qualities_column">
	                    ...
	                    <div class="caption">
	                        ...
	                        <p>
							Meat is soft, easily chewable, and not tough or stringy. Achieving tenderness in barbecue often involves breaking down collagen and connective tissue through prolonged cooking at low temperatures. The result is meat that melts in the mouth and is enjoyable to eat.
	                        </p>
	                    </div>
	                </div>
				</div>
            ...
            <div class="row">
                <div class="col-lg-6 sm-padding">
                    <div class="contact-info">
                        ...
                        <p>
						Did you know that barbecue has a long history dating back thousands of years? Archaeological evidence suggests that early humans may have practiced some form of barbecue cooking over open flames as far back as the Paleolithic era.
                        </p>
                        <h3>
            ...
            <div class="row">
                <div class="col-lg-3 col-md-6">
                    <div class="footer_widget">
                        <img src="Litas.png" alt="Restaurant Logo" style="width: 150px;margin-bottom: 20px;">
                        <p>
